...
BUCKET_NAME = "mlops-kgptalkie-faraz" # global variable
...
if download_model_button:
    with st.spinner("Donwloading.Please wait..."):
...
classifier = pipeline("text-classification","tinybert-sentiment-analysis",device=device)
